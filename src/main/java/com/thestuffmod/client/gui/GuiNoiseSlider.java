...
public class GuiNoiseSlider extends GuiButton
{
    ...
    public GuiNoiseSlider(int id, int x, int y, String label)
    {
        this(id, x, y, label, 0.0F, 1.0F);
    }

    public GuiNoiseSlider(int id, int x, int y, String label, float min, float max)
    {
    ...
    public int getNormalisedValue() {
    	return (int)(this.sliderValue*19f)+1;
    }
